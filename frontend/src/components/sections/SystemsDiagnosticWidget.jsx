...
export default function SystemsDiagnosticWidget() {
  ...
  return (
    <section className="py-20 lg:py-24 bg-gradient-to-b from-slate-900 via-slate-950 to-slate-900 text-white border-b border-slate-800 relative overflow-hidden" id="diagnostic-tool">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center max-w-3xl mx-auto mb-14">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-400/10 border border-amber-400/20 text-amber-300 text-xs font-bold uppercase tracking-wider mb-3">
            <Sparkles className="w-3.5 h-3.5" />
            <span>Interactive Self-Check</span>
          </span>
          <h2 className="font-display text-2xl sm:text-4xl font-extrabold text-white leading-tight mb-3">
        ...
        {/* 2-Column Interactive Interactive Workbench */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          
          {/* Left Column: Selectors */}
          <div className="lg:col-span-6 space-y-6 bg-slate-950/80 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl">
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-[11px] text-slate-500 font-mono">01/02</span>
              </div>
              <div className="grid grid-cols-2 gap-2">
                {sectorOptions.map((sector) => (
                  <button
                    ...
                    className={`px-3 py-2.5 rounded-xl text-xs font-semibold text-left transition-all duration-150 cursor-pointer border ${
            ...
            <div className="pt-4 border-t border-slate-800/80">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-[11px] text-slate-500 font-mono">02/02</span>
              </div>
                ...
                {painPointOptions.map((pain) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full p-3 rounded-xl text-xs text-left transition-all duration-150 cursor-pointer border flex items-start gap-2.5 ${
                        isSelected
          ...
          <div className="lg:col-span-6 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 border-2 border-amber-500/40 rounded-3xl p-6 sm:p-8 shadow-2xl relative overflow-hidden">
            ...
            <div className="flex items-start gap-4 mb-6 p-4 rounded-2xl bg-slate-900/90 border border-slate-800">
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="space-y-2.5">
                {matchedPain.deliverables.map((item, idx) => (
                  <div key={idx} className="p-3 rounded-xl bg-slate-950/80 border border-slate-800/90 flex items-center gap-3">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 pt-4 border-t border-slate-800">
              <Button to="/contact" variant="gold" size="md" icon={ArrowRight} className="w-full sm:w-auto">
                Request Diagnostic for {matchedPain.recommendedDivision}
              </Button>
              <Button to={`/services/${matchedPain.slug}`} variant="outline" size="md" className="border-slate-700 text-white hover:bg-slate-900 w-full sm:w-auto">
                View Full Division
              </Button>
            </div>
          </div>
