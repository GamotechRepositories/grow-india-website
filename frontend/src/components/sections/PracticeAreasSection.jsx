    ...
    <section className="py-20 lg:py-24 bg-slate-50 border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mt-14">
          ...
          <div className="p-8 sm:p-10 rounded-3xl bg-white border border-slate-200 shadow-sm flex flex-col justify-between hover:border-amber-400/60 transition-all duration-200">
            <div>
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-1.5">
                  ...
                  <span className="px-2.5 py-1 rounded-lg bg-amber-100 text-[11px] font-bold text-amber-900">
                    +5 more categories
                  </span>
                </div>
              </div>
            ...
            <div className="pt-4 border-t border-slate-100">
              <Button to="/corporate-consulting" variant="primary" size="md" icon={ArrowRight} className="w-full">
          ...
          <div className="p-8 sm:p-10 rounded-3xl bg-white border border-slate-200 shadow-sm flex flex-col justify-between hover:border-amber-400/60 transition-all duration-200">
                ...
                <div className="flex flex-wrap items-center gap-1.5 text-xs font-bold text-slate-900">
                  {whyGovernmentSystemsMatter.contributionFlow.steps.map((step, idx) => (
                    <span key={idx} className="flex items-center gap-1">
                      <span className="px-2 py-0.5 rounded bg-white border border-amber-200 text-slate-800">
                        {step}
                      </span>
            ...
            <div className="pt-4 border-t border-slate-100">
              <Button to="/government-consulting" variant="primary" size="md" icon={ArrowRight} className="w-full">
