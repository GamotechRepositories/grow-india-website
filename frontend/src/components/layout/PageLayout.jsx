  ...
  return (
    <div className="fixed bottom-5 right-5 z-40 flex flex-col items-end gap-2.5">
      ...
      <a
        ...
        aria-label="Connect on WhatsApp Business"
        className="flex items-center gap-2.5 px-4 py-2.5 rounded-full bg-emerald-500 hover:bg-emerald-600 text-white font-bold text-xs sm:text-sm shadow-xl hover:shadow-emerald-500/30 transition-all duration-300 hover:scale-105 group border border-emerald-400/40"
      >
