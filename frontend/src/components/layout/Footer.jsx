        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
            ...
            <div className="pt-2">
              ...
              <div className="flex items-center gap-2">
                <a
                  ...
                  className="w-9 h-9 rounded-xl bg-emerald-500/20 text-emerald-400 hover:bg-emerald-500 hover:text-slate-950 flex items-center justify-center transition-colors border border-emerald-500/30"
                >
                ...
                <a
                  ...
                  className="w-9 h-9 rounded-xl bg-pink-500/10 text-pink-400 hover:bg-pink-500 hover:text-white flex items-center justify-center transition-colors border border-pink-500/30"
                >
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="Facebook"
                  className="w-9 h-9 rounded-xl bg-blue-500/10 text-blue-400 hover:bg-blue-600 hover:text-white flex items-center justify-center transition-colors border border-blue-500/30"
                >
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="LinkedIn"
                  className="w-9 h-9 rounded-xl bg-sky-500/10 text-sky-400 hover:bg-sky-600 hover:text-white flex items-center justify-center transition-colors border border-sky-500/30"
                >
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs">
              ...
              <li>
                <Link to="/clients-and-partners" className="hover:text-amber-400 transition-colors">
                  Clients & Partners
                </Link>
              </li>
            </ul>
